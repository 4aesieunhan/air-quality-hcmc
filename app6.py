...
/* Global catch: any element without explicit color inherits dark */
[data-testid="stApp"] p,
[data-testid="stApp"] span:not(.kpi-badge):not(.station-badge):not(.live-badge):not(.no-data-badge),
[data-testid="stApp"] div:not([style]) { 
    color: inherit; 
}
...
.page-hero h1 {
    ...
    color: #1a202c !important; margin: 0 0 6px; line-height: 1.2;
}
...
.kpi-label {
    ...
    letter-spacing: 1px; color: #718096 !important;
...
.section-heading {
    ...
    color: #1a202c !important; margin: 0 0 16px;
}
...
.station-name  { font-size: 15px; font-weight: 700; color: #1a202c !important; }
.station-addr  { font-size: 12px; color: #a0aec0 !important; margin-bottom: 14px; }
.station-aqi   {
    font-size: 48px; font-weight: 800;
    font-family: 'JetBrains Mono', monospace;
    color: #1a202c !important; line-height: 1; margin-bottom: 6px;
}
.station-badge {
...
.pollutant-label {
    font-size: 11px; color: #a0aec0 !important; font-weight: 500;
    margin-bottom: 2px; text-transform: uppercase; letter-spacing: 0.5px;
}
.pollutant-value {
    font-size: 16px; font-weight: 700; color: #2d3748 !important;
    font-family: 'JetBrains Mono', monospace;
}
.live-badge {
...
.eda-hero h1 { font-size: 30px; font-weight: 800; color: #1a202c !important; margin: 0 0 6px; }
...
.stat-label {
    font-size: 13px; color: #718096 !important; margin-bottom: 8px;
    display: flex; justify-content: space-between;
}
.stat-value {
    font-size: 30px; font-weight: 800;
...
.chart-panel-title {
    font-size: 15px; font-weight: 700; color: #1a202c !important;
    margin-bottom: 4px; display: flex; align-items: center; gap: 8px;
}
.chart-panel-sub { font-size: 12px; color: #718096 !important; margin-bottom: 14px; }
...
/* ── Streamlit: force ALL text dark on light bg ── */
/* Labels */
...
/* Radio button text (tab switcher) */
...
/* Checkbox label */
.stCheckbox label span { color: #1a202c !important; }

/* General markdown text - catch-all */
